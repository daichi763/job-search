...
- 情報が不足している項目は中立。
【実務経験年数の照合（添付書類がある場合）】
- 要望に【職種別の経験年数】や【総経験年数】がある場合、求人の[確]必須要件に書かれた
  「〇〇の実務経験N年以上」等の経験要件と照合する。
- 求職者の該当職種の経験年数が、求人が求める年数を「明確に大きく下回る」場合は大きく減点する
  （例: 求人「営業経験5年以上必須」× 求職者「営業1年」）。ただし候補からの除外はしない。
- 求人要件を満たす、または上回る場合は加点し、理由でその強みに触れる。
- 「歓迎」「尚可」等の必須でない経験要件は、満たさなくても減点しない（満たせば軽く加点）。
- 必須要件の記載が曖昧で必須か歓迎か不明な場合は、減点しすぎず中立寄りに扱う（誤読による取りこぼし防止）。
...
- 【職種別の経験年数】がある場合、経験年数の長い職種を軸にしたプランを優先的に作る（経験が浅い職種で絞りすぎない）。
  経験年数が十分な職種は、より上位/専門的な求人も狙えるプランに含めてよい。
